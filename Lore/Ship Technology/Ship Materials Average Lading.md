...
This register defines minimum installed and carried lading values for treasury reconciliation, mass-accounting, and supply-chain fault checking. It does not authorize supplier substitution, production routing, manufacturing tolerances, or final purchase quantities. The register is a truth-pass minimums sheet. It exists to identify ordering, loading, or ledger faults against the current accepted lading basis.
...
Capacitor lading covers the minimum energy storage required to drive piston actuation and regenerative braking for one full stroke, adhering to the 80% maximum load rule. Banks are housed in the 2m radial × 35–60m axial maintenance crawl space extending around each ring. **We have added a 10% capacitor buffer on top of these numbers for safety protocols as per Terran Federation's Compliance Adherence.** All values are first-pass treasury minimums for supply-chain fault checking and mass-accounting.

#### **Constraints and Rules**

- **Energy Storage Rule**: Capacitor banks must store sufficient energy for **one full stroke at 80% max load** (no full-throttle operation).
- **Placement Rule**: Banks are distributed in the **2m radial × 35–60m axial crawl space**.
- **Redundancy Rule**: **1 cell per 2 rings** (for Nimbus) to ensure even distribution and fault tolerance.
- **Material Rule**: Use **space-grade lithium-free hybrid supercapacitors** (206 Wh/kg, 59.74 Wh/L, 3.3V).
...
- Do not double-count buswork or cooling as separate lading; these are included in cell mass/volume.
- Banks are **not** part of the 0.25 cm³/cell packaged actuator-cell allowance (Section 1).
...
| **Ship / Coil** | **Ring Count** | **Total Cells** | **Total Mass** | **Total Volume** | **Notes**          |
| --------------- | -------------- | --------------- | -------------- | ---------------- | ------------------ |
| Nimbus          | 200            | 100             | 550 kg         | 2 m³             | 1 cell per 2 rings |
| Zephyr          | 300            | 150             | 825 kg         | 3 m³             | Scaled linearly    |
| Stratus         | 400            | 200             | 1,100 kg       | 4 m³             | &nbsp;             |
| Atlas           | 600            | 300             | 1,650 kg       | 6 m³             | &nbsp;             |
