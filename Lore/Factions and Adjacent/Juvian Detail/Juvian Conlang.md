...
Juvian is relation-dependent SVO by default:

Named nouns must precede the complete conjugated verb set.
Objects follow the verb, except in negatory or relational statements, where the object may invert to first position for emphasis or logical focus.
Prepositions appear after the noun they modify but before the verb they relate to.

Examples:

IPA: [ʒaˈʔu ʒeβi ɗɵˈpit ɹaʒ ɗɵˈpiɠrat ɠˈrat ɡonatˈota ʒaˈβu]
Gloss: they-plural water toward fire to-beyond forward along-intersecting future-perfect
English: They will have gone forward beyond the water toward the fire along the intersecting path.

IPA: [?an ɹpuβ ʒaǀu]
Gloss: not food they-plural
English: They don't eat food.

IPA: [koni ʒaǀu roka-latʒaǀ]
...
Juvians have a unique verb for the act of owning something. It has its own conjugation. Possessive verbs conjugate afrter the noun before the functional verb. 
The verb also functions as a short change possesive like English `its` or `theirs`. In such a case conjugate the noun itself as if it were a verb according to the chart. 
...
---
## Nominalized Actions (The "Gerund" Problem)

Juvian lacks a true gerund. Actions cannot be converted into static nouns. To express the _concept_ of an action as a subject (e.g., "Walking is difficult"), Juvians use the **Conceptual Wrapper** `?uɹ` (Act/Deed).

**Structure:** `?uɹ [Conjugated Verb]`

|English|Juvian|Gloss|
|---|---|---|
|Walking (The act of)|`?uɹ irmkaʒaǀ`|Act [of] walking-continuous-they|
|Speech (The act of)|`?uɹ mukkaʒaǀ`|Act [of] speaking-continuous-they|

_Note: The verb inside the wrapper usually defaults to the "They (S)" or "They (P)" suffix to represent a general or universal agent._
...
### Anchor Set
- **[Anchor]** – Root noun designating the fixed point or entity from which direction is derived. Must always be declared unless speaker is implicit. Generally defaults to the speakers favored side. In technological eras this is usually derived using known clock standards. 
...
> 3. A **Polarity** — indication of directionality (positive/negative) from that anchor. Positive is often in respect to its position to its supporting anchor. Hand? Palm is positive. Chest? Frontal thorax vectors positive. `An(i)` negates that property, thus implying the inverse.
...
| ---------------------- | --------------- |
| During                 | \|ɵtitoti       |
| Before / After         | ɠratiʎɵti       |
| Since                  | ʎɵti            |
| Until                  | χɵti            |
| By                     | ɵti             |
| As                     | ɵto             |
| Afterward / Beforeward | ɗɵ\|iti         |

### Zone-Based Conditions
| Concept                | Root Word [TBD] |
| ---------------------- | --------------- |
| At (static)            | gona            |
| Along (path-following) | tota            |
| Intersecting           | gonatota        |
| Covering               | tɵp\|ɵtit       |
| Exclusion Zone         | anitɵte         |
|                        |                 |
